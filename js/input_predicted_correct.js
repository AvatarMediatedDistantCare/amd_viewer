...
// loader.load("model/kinect_banaoh.js", function(geometry, mats) {
  ...
  // motion_data[0] = load_csv("data/kinect/ki_crossing_arms_back_splitted.csv");
  // motion_data[1] = load_csv("data/predict/ki_crossing_arms_back_splitted_predict_apply_normalize.csv");
